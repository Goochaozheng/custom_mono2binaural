...
class AudioNet(nn.Module):
    def __init__(self, ngf=64, input_nc=2, output_nc=2):
        ...
        self.visual_fusion1 = create_conv(256, 8, 1, 0) #reduce dimension of extracted visual features
        self.visual_fusion2 = create_conv(256, 8, 1, 0) #reduce dimension of extracted visual features
        self.visual_fusion3 = create_conv(256, 8, 1, 0) #reduce dimension of extracted visual features
        self.visual_fusion4 = create_conv(256, 8, 1, 0) #reduce dimension of extracted visual features
        self.visual_fusion5 = create_conv(256, 8, 1, 0) #reduce dimension of extracted visual features
