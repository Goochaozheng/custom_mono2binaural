...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--data_path', required=True, help='path to the data h5')
		...
		self.parser.add_argument('--model_path', type=str, default='', help="path of trained model")
		...
		self.parser.add_argument('--comment', type=str, default='', help='mark the directory of output')
